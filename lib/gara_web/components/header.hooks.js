import {toByteArray, fromByteArray} from "../../vendor/base64-js/index.js"
...
export default {
	...
	let textInput = this.el.querySelector("textarea#text-compose");
	if (textInput)
	    textInput.addEventListener("keydown", (e) => this.handleKey(e));
